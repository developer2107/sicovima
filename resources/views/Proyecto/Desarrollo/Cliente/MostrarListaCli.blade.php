            ...
            <tbody>
              @foreach($cliente as $cli)
                <tr>
                    ...
                    <td align="center">
                      <a href="VerCliente" class="btn btn-primary btn-circle" type="button"><i class="fa fa-eye"></i>
                      </a>
                      <a href="ModificarCli" class="btn btn-success btn-circle" type="button"><i class="fa fa-pencil-square-o"></i>
