...
<head>
  <meta charset="UTF-8">
  <title>Reporte Clientes Activos</title>
  <style>
  footer {
      position: fixed;
      left: 0px;
...
<!-- <img alt="image" class="img-responsive" src="../img/Mada-Denim-Blanco4.jpg"> -->
        ...
        <?php  
          ...
          $cliente = SICOVIMA\cliente::orderby('nombre_Cli')->where('estado_Cli',1)->get(); 
           ?>
          <div style="position: absolute;left: 310px; top: 180px; z-index: 1;"><h3>CLIENTES ACTIVOS</h3></div>
