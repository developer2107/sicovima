...
<head>
  <meta charset="UTF-8">
  <title>Reporte Clientes Naturales</title>
  <style>
    footer {
      position: fixed;
      left: 0px;
        ...
        <HR style="position: absolute;left: 270px; top: 30px; z-index: 1; color:black;" width=35%>
          ...
          <HR style="position: absolute;left: 270px; top: 50px; z-index: 1; color:black;" width=35%>
            ...
            <div class="box-body">
              ...
              $cliente = SICOVIMA\cliente::orderby('nombre_Cli')->where('tipo_Cli',0)->get(); 
              ?>
              <div style="position: absolute;left: 310px; top: 180px; z-index: 1;"><h3>CLIENTES NATURALES</h3></div>
              ...
              <tbody>
               ...
               <tr>
                ...
                <td style = "width:10%">{{$cli->nombre_Cli}}</td>

                <?php
                $duiC = SICOVIMA\clienteNatural::where('id_Cliente',$cli->id)->get()->first();
                ?>

                <td style = "width:10%">{{$duiC->DUI_CN}}</td>
                <?php
