...
<tr>
  ...
  <td align="rihgt" style = "width:20%"><a href="comprasFecha/1" class="btn btn-primary btn-circle" type="button"><i class="fa fa-eye"></i></a></td>
  <td align="rihgt" style = "width:20%"><a href="comprasFecha/2" class="btn btn-primary btn-circle" type="button"><i class="fa fa-download"></i></a></td>
</tr>
<!-- <tr>
