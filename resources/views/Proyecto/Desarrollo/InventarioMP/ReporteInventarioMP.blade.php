...
<!-- <img alt="image" class="img-responsive" src="../img/Mada-Denim-Blanco4.jpg"> -->
      ...
      <div class="box-body">
        ...
        $materiaP = SICOVIMA\materiaPrima::all();
        $inventario = SICOVIMA\inventarioMateriaPrima::where('id_MateriaPrima',22)->get()->last();
        ...
        <table class="table-wrapper" >
           <thead>
            <tr>
              ...
              <th style="color: white; font-weight: bold;">Unidad de Medida</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style = "width:30%">{{$mat->nombre_MP}}</td>
              <td style = "width:30%">{{$mat-> tipoMercaderia->nombre_TM}}</td>
              <td style = "width:20%">{{$mat->color_MP}}</td>
              <td style = "width:20%"><i class="fa fa-usd"></i>  {{$mat->precio_MP}}</td>
              <td style = "width:30%">{{$mat->unidadMedida_MP}}</td>
              <td style = "width:20%">{{$inv->nuevaExistencia_IMP}}</td>
