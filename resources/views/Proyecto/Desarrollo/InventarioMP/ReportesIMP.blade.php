...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>Reportes de Inventario Materia Prima</strong>
            </li>
        </ol>
    </div>
    <div class="col-sm-8">  
...
<div class="row">
  ...
  <td align="center" style = "width:10%"><a href="ReporteInventarioMP/1" target="_blank" class="btn btn-primary btn-circle" type="button"><i class="fa fa-eye"></i></a></td>
</tr>
<!-- <tr>
