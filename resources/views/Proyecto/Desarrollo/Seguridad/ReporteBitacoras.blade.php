    ...
    <div class="box-body">
      <div class="box-header with-border">
        ...
        <?php   
          ...
          $fechaNueva = SICOVIMA\fecha::find($nuevaF);
          $fechain = $fechaNueva->fechai;
          $fechafi = $fechaNueva->fechaf;
          $datoi = explode("-",(String)$fechain);
          $fechaINicial = $datoi[2]."/".$datoi[1]."/".$datoi[0];
          $datof = explode("-",(String)$fechafi);
          $fechaFInal = $datof[2]."/".$datof[1]."/".$datof[0];
          ?>
      ...
      <div class="box-body">
        ...
        <table class="table-wrapper" >
          ...
          <tbody>
            ...
            <?php if ($fechaOrdenada>=$fechaINicial && $fechaOrdenada<=$fechaFInal): ?>
              <tr>
