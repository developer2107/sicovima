...
@section('content')
{!! Form::model($venta,['route'=>['RegistrarVenta.update',$venta->id], 'method'=>'PUT']) !!}
                    ...
                    ?>
                        <tr>
                           ...
                           <td style = "width:20%">
                            ...
                            <a class='btn btn-success btn-circle' type='button' id='Eliminar'><i class='fa fa-pencil-square-o'></i></a><a class='btn btn-success btn-circle' type='button' id='ModificarDetalle'><i class='fa fa-pencil-square-o' data-dismiss="modal" data-toggle="modal" data-target="#myModal6" onclick="{{$cadena}}"></i></a></td> 
                        </tr>
                    <?php 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="input-group m-b">
                            ...
                            {!! Form::number('total_Ven',$total,['class'=>'touchspin2 form-control','step'=>'any', 'id'=>'totalVenta']) !!}
                        </div>
                    </div>
                </div>
            </div>
