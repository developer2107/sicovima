...
@section('content')
{!! Form::open(['route'=>'RegistrarVenta.store', 'method'=>'post']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="input-group m-b">
                            ...
                            {!! Form::number('total_Ven',0.00,['class'=>'touchspin2 form-control','step'=>'any', 'id'=>'totalVenta']) !!}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="ibox-content">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group bootstrap-touchspin">
                                {!! Form::text('numeroDoc',null,['id' => 'numeroDoc','class'=>'form-control','style' => 'width:150px']) !!}
                            </div>
                        </div>
                        <div class="col-md-1">
                        </div>
                 ...
                 <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" id="tablaProductosTerm">
                            ...
                            @foreach ( $inventarioProductoTerminados as $inventarioProductoTerminado )
                            <?php
                            $prod=SICOVIMA\producto::find($inventarioProductoTerminado->id_Producto);
                            ?>
                            <tr>
                                ...
                                <td align="left"><font size="4" >{{$inventarioProductoTerminado->nuevaExistencia_IPT}}</font></td>
                                ...
                                <td align="center">
                                    ...
                                    <input type="hidden" value='{{$inventarioProductoTerminado->nuevaExistencia_IPT}}'>
...
<div class="modal inmodal" id="myModal6" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content animated fadeIn">
            ...
            <div class="modal-footer">
                <input class="btn btn-primary" name="agregarVentas" id="agregarVentas" type="button" value="Agregar"/>
